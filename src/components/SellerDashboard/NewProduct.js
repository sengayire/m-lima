                ...
                <div className='new-product-description'>
                    ...
                    <div className='product-form-inputs-container'>
                        ...
                        <div className='form-product-image'>
                            <span className='product-form-edit'><a>Edit</a></span>
                        <div className='product-image'>
                                <div className='product-image-box'>Image Here</div>
                                <span className='upload-product-image'><a>Set featured image</a></span>
                        <div className='product-form-btn'>
                            <FormButton background='transparent' title='Save as draft' color='#2090ff' border='#2090ff'/>
